...
User = input(str("Enter either 'investment' or 'bond' from the menu above to proceed: ")).lower()
...
if User == "investment": 
    if True:
        ...
        Investment_type = str(input("Choose Simple or Compound interest: \n")).lower()
        if Investment_type == "simple":
            ...
            print(f"Your interest earned over {t} years will be GBP {total: .2f}".format()) 
